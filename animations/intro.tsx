...
export default function ASCIIText({
    ...
    useEffect(() => {
      ...
      // Dynamically adjust font sizes for responsiveness
      const dynamicAsciiFontSize = Math.max(2, Math.floor(width / 200));
      const dynamicTextFontSize = Math.max(30, Math.floor(width / 10));
  
      asciiRef.current = new CanvAscii(
        {
          text,
          asciiFontSize: dynamicAsciiFontSize,
    ...
    }, [text, textColor, planeBaseHeight, enableWaves]);
